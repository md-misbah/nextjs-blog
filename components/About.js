            ...
            <div className="sm:container mx-auto">
                <div className="aboutWrapper w-11/12 m-auto">
                    <div className="aboutHeadingTitle mb-12">
                        <h3 className='subTitle mx-auto text-center text-sm textAlt mb-1.5'>My Intro</h3>
